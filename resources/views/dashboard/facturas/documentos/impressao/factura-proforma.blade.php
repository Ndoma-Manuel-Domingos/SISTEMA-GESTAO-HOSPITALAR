...
<head>
    <meta charset="utf-8">
    <title>{{ $factura->factura_next }} - FACTURA PRÓ-FORMA</title>
...
<body>
    <div class="container">
        ...
        <table class="header">
            <tr>
                ...
                <td width="40%" align="right">
                    ...
                    <h1>{{ $factura->factura_next }} conforme {{ $factura->numeracao_proforma }}</h1>
                    @else
                    <h1>{{ $factura->factura_next }}</h1>
                    @endif
        ...
        <table width="100%">
            <tr>
                <td width="55%" valign="top">
                    ...
                    <p>{{ $factura->valor_extenso ?? 'Sem descrição por extenso' }}</p>
                </td>
        ...
        <!-- COORDENADAS BANCÁRIAS (FINAL DA PÁGINA) -->
        <table class="bancos">
            <tr>
                <td colspan="3" class="titulo-banco">
            ...
            <tr>
                <td class="banco-box">
                    <strong>BANCO 1</strong><br>
                    Banco: {{ $empresa_logada->empresa->banco }}<br>
                    Conta: {{ $empresa_logada->empresa->conta }}<br>
                    IBAN: {{ $empresa_logada->empresa->iban }}
                </td>

                <td class="banco-box">
                    <strong>BANCO 2</strong><br>
                    Banco: {{ $empresa_logada->empresa->banco1 }}<br>
                    Conta: {{ $empresa_logada->empresa->conta1 }}<br>
                    IBAN: {{ $empresa_logada->empresa->iban1 }}
                </td>

                <td class="banco-box">
                    <strong>BANCO 3</strong><br>
                    Banco: {{ $empresa_logada->empresa->banco2 }}<br>
                    Conta: {{ $empresa_logada->empresa->conta2 }}<br>
                    IBAN: {{ $empresa_logada->empresa->iban2 }}
                </td>
            </tr>
        </table>
...
<body>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">{{ number_format($item->iva_taxa, 1, ',', '.') }}</td>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th style="text-align: left">{{ __('messages.imposto') }}</th>
    ...
    <footer>
            ...
            <div class="col">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $empresa_logada->empresa->banco2 }}</td>
                            <td>{{ $empresa_logada->empresa->conta2 }}</td>
                            <td>{{ $empresa_logada->empresa->iban2 }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <h1 style="font-size: 14pt;color: red">Este documento não serve como factura</h1>
