...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Saldos dos Caixas</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-tools">
                                <a class="btn btn-light-danger" target="_blank" href="{{ route('transacoes-financeiras-saldos-caixas-imprimir') }}"><i class="fas fa-file-pdf"></i> IMPRIMIR PDF</a>
                            </div>
                        </div>
                        @if ($saldos_caixas)
                        <!-- /.card-header -->
                            ...
                            <table class="table table-hover text-nowrap" id="carregar_tabela" style="width: 100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{-- <a href="{{ route('caixas.show', $item->id) }}" class="btn btn-light-primary float-right"><i class="fas fa-info"></i> {{ __('messages.mais_detalhes') }}</a> --}}
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
