...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Períodos Rendimentos</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                    ...
                                                    <a class="dropdown-item" href="{{ route('periodos-rendimentos.show', $item->id) }}"><i class="fas fa-eye text-light-primary"></i> {{ __('messages.mais_detalhes') }} </a>
                                                    @endif
                                                    ...
                                                    @if (Auth::user()->can('eliminar todos') || Auth::user()->can('eliminar periodo'))
    ...
    <form action="{{ route('periodos-rendimentos.store') }}" method="post" class="">
        @csrf
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body row py-4">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control form-control-lg" name="numero" id="numero" value="{{ old('numero') }}" placeholder="Informe o Número de Dias">
                            </div>
                        </div>
...
<script>
    ...
    $(document).on('click', '.edit-folder', function(e) {
        ...
        $.ajax({
            url: `{{ route('periodos-rendimentos.edit', ':id') }}`.replace(':id', recordId)
            , method: 'GET'
            , data: {
