...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">{{ $departamento->nome }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('documentos.index') }}">{{ __('messages.voltar') }}</a></li>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            @if (count($departamento->pastas) != 0)
            <div class="row">
                <div class="col-12 col-md-12">
                    <ul class="mailbox-attachments d-flex align-items-stretch clearfix">
                        @foreach ($departamento->pastas as $item)
                        <li>
                            <span class="mailbox-attachment-icon"><i class="far fa-folder"></i></span>
                            <div class="mailbox-attachment-info">
                                <a href="#" class="mailbox-attachment-name py-2 d-block">
                                    {{ $item->nome }}
                                </a>
                    ...
                    <div class="card">
                        <div class="card-body text-center">
                            <p>Sem pastas cadastadas no momento
                                clica aqui para criar novos pastas
                            </p>
                            <button type="button" onclick="toggleModal()" class="btn btn-light-primary">
                                <i class="fas fa-folder"></i> <i class="fas fa-plus"></i> {{ __('messages.novo') }}
                            </button>
            ...
            @if (count($departamento->files) != 0)
            <div class="row">
                <div class="col-12 col-md-12">
                    <ul class="mailbox-attachments d-flex align-items-stretch clearfix">
                        @foreach ($departamento->files as $item)
                        <li>
        ...
        <form action="{{ route('pastas.store') }}" method="post" class="">
            @csrf
            <div class="modal fade" id="modal-lg">
                <div class="modal-dialog modal-lg  modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">{{ $departamento->nome }} » Pasta</h4>
                        ...
                        <div class="modal-body row py-4">
                            ...
                            <input type="hidden" name="departamento_id" id="departamento_id" value="{{ $departamento->id }}">
...
<script>
    ...
    function uploadFicheiro() {
        ...
        $.ajax({
            url: '/gestao-documentos/upload-multifiles'
            , type: 'POST'
            , data: formData
            , processData: false
            , contentType: false
