...
<div class="content-wrapper">
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                    ...
                                                    <a class="dropdown-item  edit-folder" data-id="{{ $item->id ?? "" }}" href="#"><i class="fas fa-edit text-light-success"></i> {{ __('messages.actualizar') }}</a>
                                                    @endif
    ...
    <form action="{{ route('departamentos.store') }}" method="post" class="">
        @csrf
...
<script>
    ...
    $(document).on('click', '.edit-folder', function(e) {
        ...
        $.ajax({
            url: `{{ route('departamentos.edit', ':id') }}`.replace(':id', recordId)
            , method: 'GET'
            , data: {
