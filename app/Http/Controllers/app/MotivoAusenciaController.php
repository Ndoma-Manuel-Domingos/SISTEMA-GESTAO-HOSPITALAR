...
class MotivoAusenciaController extends Controller
{
    ...
    public function index()
    {
        ...
        $motivos = MotivoAusencia::where("entidade_id", $entidade->empresa->id)->orderBy('created_at', 'desc')->get();
        ...
        return view('dashboard.motivos-ausencias.index', $head);
    }
    ...
    public function create()
    {
        ...
        return view('dashboard.motivos-ausencias.create', $head);
    }
    ...
    public function show($id)
    {
        ...
        $motivo = MotivoAusencia::findOrFail($id);
        ...
        return view('dashboard.motivos-ausencias.show', $head);
    }
    ...
    public function edit($id)
    {
        ...
        return view('dashboard.motivos-ausencias.edit', $head);
    }
