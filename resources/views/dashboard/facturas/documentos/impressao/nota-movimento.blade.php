...
<body style="background-image: url('/public/images/empresa/{{ $empresa_logada->empresa->logotipo ?? '' }}'); background-attachment: fixed;
    ...
    <body>
        ...
        <main style="position: absolute;top: 260px;right: 30px;left: 30px;">
            <table>
                ...
                <tr>
                    <td style="text-transform: uppercase;padding: 10px 0;font-size: 11px;font-weight: bolder;border-bottom: 1px solid #000000">
                        Luanda-Angola <br><br> {{ $titulo }}</td>
                </tr>

                <tr>
                    <td style="text-transform: uppercase;font-weight: bolder;padding: 10px 0;font-size: 13px;border-bottom: 1px solid #000000">
                        {{ $movimento->numero }}</td>
                </tr>
            ...
            <table class="table table-stripeds" style="border-top: 1px dashed #000;border-bottom: 1px dashed #000;">
                <thead style="border-bottom: 1px dashed #000;x">
                    <tr>
                        <th style="padding: 2px;text-align: left;text-transform: uppercase;color: #222222;font-weight: bolder;border-bottom: 1px solid #000;text-align: right">
                            Motante</th>
                        <th style="padding: 2px;text-align: left;text-transform: uppercase;color: #222222;font-weight: bolder;border-bottom: 1px solid #000;text-align: right">
                            Conta</th>
                        <th style="padding: 2px;text-align: left;text-transform: uppercase;color: #222222;font-weight: bolder;border-bottom: 1px solid #000;text-align: right">
                ...
                <tbody>
                    <tr>
                        <td style="font-weight: bolder;padding: 3px 0;text-transform: uppercase;color: #222222;font-weight: bolder;border-bottom: 1px solid #000;text-align: right">
                            {{ $movimento->movimento == 'E' ? number_format($movimento->debito, 2, ',', '.') : number_format($movimento->credito, 2, ',', '.') }}
                        </td>
                        <td style="font-weight: bolder;padding: 3px 0;text-transform: uppercase;color: #222222;font-weight: bolder;border-bottom: 1px solid #000;text-align: right">
                            {{ $movimento->caixa->nome }}</td>
                        <td style="font-weight: bolder;padding: 3px 0;text-transform: uppercase;color: #222222;font-weight: bolder;border-bottom: 1px solid #000;text-align: right">
                            {{ $movimento->forma_movimento == 'NU' ? 'NUMERÁRIO' : 'MULTICAIXA' }}</td>
                        <td style="font-weight: bolder;padding: 3px 0;text-transform: uppercase;color: #222222;font-weight: bolder;border-bottom: 1px solid #000;text-align: right">
        ...
        <main style="position: absolute;top: 260px;right: 30px;left: 30px;width: 250px;">
            ...
            <table class="table table-stripeds" style="border-top: 1px dashed #000;border-bottom: 1px dashed #000;">
                <thead style="border-bottom: 1px dashed #000;x">
                    <tr>
                        <th style="padding: 2px;text-align: left;text-transform: uppercase;color: #222222;font-weight: bolder;border-bottom: 1px solid #000;text-align: left">
                            Motante</th>
                        <th style="padding: 2px;text-align: left;text-transform: uppercase;color: #222222;font-weight: bolder;border-bottom: 1px solid #000;text-align: right">
                            Conta</th>
                    </tr>
                ...
                <tbody>
                    <tr>
                        <td style="font-weight: bolder;padding: 3px 0;text-transform: uppercase;color: #222222;font-weight: bolder;border-bottom: 1px solid #000;text-align: left">
                            {{ $movimento->movimento == 'E' ? number_format($movimento->debito, 2, ',', '.') : number_format($movimento->credito, 2, ',', '.') }}
                        </td>
                        <td style="font-weight: bolder;padding: 3px 0;text-transform: uppercase;color: #222222;font-weight: bolder;border-bottom: 1px solid #000;text-align: right">
                            {{ $movimento->caixa->nome }}</td>
