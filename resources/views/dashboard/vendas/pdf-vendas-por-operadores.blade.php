    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="border: 1px solid #010101;padding: 2px;">E-mail</th>
                <th style="border: 1px solid #010101;padding: 2px;">Administrador</th>
        ...
        <tbody>
            @php $total = 0; @endphp
                ...
                <tr>
                    ...
                    <td style="padding: 3px;text-align: left;">{{ $item->user->email }}</td>
                    <td style="padding: 3px;text-align: left;">{{ $item->user->is_admin == 1 ? "Sim" : "Não"  }}</td>
                    <td style="padding: 3px;text-align: right;">{{ number_format($item->total_valor, 2, ',', '.') }}</td>
                </tr>
        ...
        <tfoot>
            <tr>
                <td style="border: 1px solid #010101;padding: 3px;text-align: right;" colspan="4">{{ __('messages.total') }}</td>
                <td style="border: 1px solid #010101;padding: 3px;text-align: right;">{{ number_format($total ?? 0, 2, ',', '.') }}</td>
            </tr>
        </tfoot>
    </table>
