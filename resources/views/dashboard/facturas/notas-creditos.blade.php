...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Notas Creditos</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 col-12">
                    <form action="{{ route('notas-creditos') }}" method="get">
                        @csrf
                        <div class="card">
                            ...
                            <div class="card-body row">
                                <div class="col-12 col-md-12">
                                    ...
                                    <p class="text-light-danger"> @error('factura') {{ $message }} @enderror </p>
                                </div>
                            </div>
                            <div class="card-footer">
                                <button class="btn-sm btn-light-primary ml-2 text-right"><i class="fas fa-filter"></i> {{ __('messages.filtrar') }}</button>
                            </div>
                        </div>
                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('pdf-notas-creditos') }}" target="_blank" class="btn btn-light-primary float-right"><i class="fas fa-file-pdf"></i> {{ __('messages.exportar_pdf') }}</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table class="table table-hover text-nowrap" id="carregar_tabela" style="width: 100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><a href="{{ route('factura-nota-credito', $item->code) }}" target="_blank"><i class="fas fa-print"></i> </a></td>
                                    </tr>
                                    @endforeach
                                    @endif
                                </tbody>
