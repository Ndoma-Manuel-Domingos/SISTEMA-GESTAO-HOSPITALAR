...
<main style="position: absolute;top: 200px;right: 30px;left: 30px;">
    <table>
        <tr>
            <th style="font-size: 13px;text-transform: uppercase;border-bottom: 2px solid #3f3f3f;padding: 5px;">Recibo
                de {{ $processamento->processamento->nome }} </th>
        </tr>
    </table>
    ...
    <table style="margin-top: 50px;border-top: 1px solid #000000;padding: 10px">
        ...
        <tr>
            ...
            <td style="border-bottom: 1px solid #cecece;padding: 5px;margin: 5px"></td>
            <td style="border-bottom: 1px solid #cecece;padding: 5px;margin: 5px" colspan="3">Segurança Social(3%)
            </td>
            <td style="border-bottom: 1px solid #cecece;padding: 5px;margin: 5px"></td>
            <td style="border-bottom: 1px solid #cecece;padding: 5px;margin: 5px;text-align: right">
        ...
        @foreach ($processamento->funcionario->contrato->descontos_contrato as $item)
            @if ($item->tipo == 'O')
                <tr>
                    <td style="border-bottom: 1px solid #cecece;padding: 5px;margin: 5px">
                        {{ $item->desconto->numero ?? '' }}</td>
                    <td style="border-bottom: 1px solid #cecece;padding: 5px;margin: 5px"></td>
                    <td style="border-bottom: 1px solid #cecece;padding: 5px;margin: 5px" colspan="3">
                        {{ $item->desconto->nome ?? '' }}</td>
                    <td style="border-bottom: 1px solid #cecece;padding: 5px;margin: 5px"></td>
                    <td style="border-bottom: 1px solid #cecece;padding: 5px;margin: 5px;text-align: right">
                        {{ number_format($item->salario, 2, ',', '.') }} {{ $item->tipo_valor == 'P' ? '%' : ' AKZ' }}
                    </td>
                </tr>
            @endif
        @endforeach
