        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-md-12">
                    ...
                    <div class="card">
                        <form action="{{ route('lotes.update', $lotes->id) }}" method="post" class="">
                            @csrf
                            @method('put')
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <select name="produto_id" id="produto_id" class="form-control select2">
                                                ...
                                                <option value="{{ $item->id ?? "" }}" {{ $lotes->produto_id == $item->id ? 'selected' : '' }}>{{ $item->nome }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-12 col-md-3">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="lote" value="{{ $lotes->lote ?? old('lote') }}" placeholder="Informe o lote">
                                        </div>
                                        <p class="text-light-danger">
                                            @error('lote')
                                            {{ $message }}
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="codigo_barra" value="{{ $lotes->codigo_barra ?? old('codigo_barra') }}" placeholder="Informe o codigo_barra">
                                        </div>
                                        <p class="text-light-danger">
                                            @error('codigo_barra')
                                            {{ $message }}
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="date" class="form-control" name="data_validade" value="{{ $lotes->data_validade ?? old('data_validade') }}" placeholder="Informe o data_validade">
                                        </div>
                                        <p class="text-light-danger">
                                            @error('data_validade')
                                            {{ $message }}
