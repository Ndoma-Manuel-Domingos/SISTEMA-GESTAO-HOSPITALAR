...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Facturas Informativo</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('pdf-facturas-informativo', $_GET['factura']) }}" target="_blank" class="btn btn-light-primary float-right"><i class="fas fa-file-pdf"></i> {{ __('messages.exportar_pdf') }}</a>
                            @else
                            <a href="{{ route('pdf-facturas-informativo') }}" target="_blank" class="btn btn-light-primary float-right"><i class="fas fa-file-pdf"></i> {{ __('messages.exportar_pdf') }}</a>
                            @endif
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12 bg-light">
                                    <form action="{{ route('facturas-informativo') }}" method="get" class="mt-3">
                                        @csrf
