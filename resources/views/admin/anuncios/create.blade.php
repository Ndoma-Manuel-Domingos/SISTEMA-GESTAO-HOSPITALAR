        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-md-12">
                    <div class="card">
                        <form action="{{ route('anuncios-admin.store') }}" method="post" class="" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body row">
                                ...
                                <div class="col-12 col-md-6">
                                    <label for="status" class="form-label">Imagem</label>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-envelope"></i></span>
                                        </div>
                                ...
                                <div class="col-12 col-md-12">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <textarea type="text" class="form-control" name="descricao" placeholder="Informe a Descrição">{{ old('descricao') }}</textarea>
                                    </div>
                                    <p class="text-light-danger">
                                        @error('descricao')
                                        {{ $message }}
