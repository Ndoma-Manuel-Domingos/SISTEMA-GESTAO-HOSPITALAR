        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12 bg-light">
                    <div class="card">
                        <form action="{{ route('transacoes-financeiras') }}" method="get" class="mt-3">
                            @csrf
                            <div class="card-body row">
                                ...
                                <input type="hidden" name="relatorio" value="{{ $request['relatorio'] ?? "" }}">
                            ...
                            <table class="table table-hover text-nowrap" id="carregar_tabela" style="width: 100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-right"> {{ __('messages.data') }} </th>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                ...
                                                <form action="{{ route('operacaoes-financeiras.destroy', $item->id ) }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-light-danger dropdown-item" onclick="return confirm('Tens Certeza que Desejas excluir esta dispesa?')">
