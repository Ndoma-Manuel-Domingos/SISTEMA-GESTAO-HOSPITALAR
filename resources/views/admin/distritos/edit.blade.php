            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('distritos.index') }}">{{ __('messages.voltar') }}</a></li>
                                ...
                                <div class="col-12 col-md-12">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select type="text" class="form-control" name="status">
                                            <option value="activo" {{ $distrito->status == "activo" ? 'selected' : '' }}>{{ __('messages.activo') }} </option>
                                            <option value="desactivo" {{ $distrito->status == "desactivo" ? 'selected' : '' }}>{{ __('messages.desactivo') }} </option>
                                        </select>
                                    </div>
                                </div>
                            </div>
