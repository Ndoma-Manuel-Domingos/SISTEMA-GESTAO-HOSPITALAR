                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('caixa.movimentos_caixa', ['data_inicio' => $requests['data_inicio'] ?? "",'data_final' => $requests['data_final'] ?? "", 'caixa_id' => $caixa->subconta_id, 'operador_id' => $requests['operador_id'] ?? "", 'documento_pdf' => 'exportar_pdf']) }}" target="_blank" class="float-right btn btn-light-primary">Exportar</a>
                        </div>
