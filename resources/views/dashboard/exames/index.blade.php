                        ...
                        <div class="card">
                            <div class="card-body row">
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <select name="prioridade_id" id="prioridade_id" class="form-control select2">
                                        <option value="">{{ __('messages.todos') }} </option>
                                        @foreach ($prioridades as $item)
                                        <option value="{{ $item->id ?? "" }}" {{ $requests['prioridade_id'] == $item->id ? "selected" : "" }}>{{ $item->nome }}</option>
                                        @endforeach
                                    </select>
                                </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                ...
                                <a href="{{ route('exames.create', ['origem' => 'padrao']) }}" class="btn btn-light-primary">Marcar Exame</a>
                                @endif
                            </h3>

                            <div class="card-tools">
                                <a class="btn btn-light-danger" target="_blank" href="{{ route("exames-imprimir-all",
                                    [
                                        'data_exame' => $requests['data_exame'] ?? "",
                                        'status' => $requests['status'] ?? "",
                                        'prioridade_id' => $requests['prioridade_id'] ?? "",
                        ...
                        <div class="card-body table-responsive">
                            <table class="table table-hover text-nowrap" id="carregar_tabela" style="width: 100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><a href="{{ route('exames.show', $item->id) }}">{{ $item->id ?? "" }}</a></td>
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                    ...
                                                    <a class="dropdown-item" target="_blink" href="{{ route('exames-imprimir-individual', $item->id) }}"><i class="fas fa-print text-light-primary"></i> {{ __('messages.imprimir') }} </a>
                                                    @endif
                                                    ...
                                                    @if ($item->status == 'AGENDADA')
                                                    <a class="dropdown-item update-record" data-id="{{ $item->id ?? "" }}" href="#"><i class="fas fa-cancel text-light-danger"></i>
