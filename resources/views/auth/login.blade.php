        ...
        <div class="card card-outline card-dark">
            <div class="card-body py-5">
                <form action="{{ route('check') }}" method="post" class="pt-3">
                    ...
                    <div class="col-12 mb-3">
                        <label for="email" class="form-label">Usuário: <span class="text-light-danger">*</span></label>
                        <div class="input-group">
                            <input type="text" class="form-control form-control-lg" id="email" name="email" value="{{ old('email') }}" placeholder="E-mail">
                        </div>
                    ...
                    <div class="col-12 mb-3">
                        <label for="password" class="form-label">Senha: <span class="text-light-danger">*</span></label>
                        <div class="input-group">
                    ...
                    <div class="row">
                        <div class="col-12 mt-2">
                            <button type="submit" class="btn-lg btn-outline-dark btn-block">Acessar</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
            ...
            <div class="card-footer">
                <p class="mb-0 mt-4 text-right row">
                    {{-- <a href="{{ route('config.configuracao') }}" class="text-left col-12 col-md-6"><i class="fas fa-cog fa-2x"></i></a> --}}
                    <a href="{{ route('licenses.upload') }}" class="text-right h4 col-12 col-md-12">Activar Licença</a> <br>
                    @if (!\App\Models\HashLicenca::first())
                    <a href="{{ route('register') }}" class="text-right h4">Configuração da empresa?</a> <br>
                    @endif
                    {{-- <a href="{{ route('register') }}" class="text-right h4">Já tens uma conta?</a> <br> --}}
                    {{-- <a href="{{ route('update_pass') }}" class="text-left text-light-dark h5">Redefinir minha senha.</a> --}}
                </p>
            </div>
            <!-- /.card-body -->
        </div>
