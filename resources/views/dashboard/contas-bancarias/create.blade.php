                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-3 mb-3">
                                        <label for="banco_id" class="form-label">Banco <span class="text-light-danger">*</span></label>
                                    ...
                                    <div class="col-12 col-md-3 mb-3">
                                        <label for="moeda" class="form-label">Moeda <span class="text-light-danger">*</span></label>
                                    ...
                                    <div class="col-12 col-md-3 mb-3">
                                        <label for="tipo_banco_id" class="form-label">Tipo Conta Bancária <span class="text-light-danger">*</span></label>
                                    ...
                                    <div class="col-12 col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="nome_agencia" name="nome_agencia" value="{{ old('nome_agencia') }}" placeholder="{{ __('messages.designacao') }}">
                                        <p class="text-light-danger">
                                            @error('nome_agencia')
                                            {{ $message }}
                                            @enderror
                                    ...
                                    <div class="col-12 col-md-3 mb-3">
                                        <label for="" class="form-label">{{ __('messages.estados') }} <span class="text-light-secondary">(Opcional)</span></label>
