...
class DepartamentoController extends Controller
{
    ...
    public function index()
    {
        ...
        $departamentos = Departamento::where("entidade_id", $entidade->empresa->id)->orderBy('created_at', 'desc')->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $count = Departamento::where('entidade_id', $entidade->empresa->id)->count();
