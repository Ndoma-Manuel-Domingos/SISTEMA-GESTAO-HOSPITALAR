...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">{{ __('messages.cargos') }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                @if (Auth::user()->can('criar todos') || Auth::user()->can('criar cargo'))
                            ...
                            <table class="table table-hover text-nowrap" id="carregar_tabela" style="width: 100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ number_format($item->salario_base, 2, ',', '.') }}</td>
                                        <td>{{ $item->status }}</td>
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                    ...
                                                    <a class="dropdown-item" href="{{ route('cargos.show', $item->id) }}"><i class="fas fa-eye text-light-primary"></i> {{ __('messages.mais_detalhes') }} </a>
                                                    @endif
                                                    ...
                                                    @if (Auth::user()->can('eliminar todos') || Auth::user()->can('eliminar cargo'))
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body row py-4">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="input-group mb-3">
                                <select type="text" class="form-control form-control-lg" id="departamento_id" name="departamento_id">
                        ...
                        <div class="col-12 col-md-6">
                            <label for="salario_base" class="form-label">Saláro Base (Opcional)</label>
                            <div class="input-group mb-3">
                                <input type="text" class="form-control form-control-lg" name="salario_base" id="salario_base" value="0" placeholder="Informe a salário base">
                            </div>
                        </div>
...
<script>
    ...
    $(document).on('click', '.edit-folder', function(e) {
        ...
        $.ajax({
            url: `{{ route('cargos.edit', ':id') }}`.replace(':id', recordId)
            , method: 'GET'
            , data: {
            ...
            , success: function(response) {
                ...
                document.getElementById('salario_base').value = response.data.salario_base;
                document.getElementById('departamento_id').value = response.data.departamento_id;
