                    ...
                    <div class="card-body row">
                        ...
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            <select type="text" class="form-control select2" name="status">
                                ...
                                <option value="activo" {{ $tipo_entidade->status == 'activo' ? 'selected': '' }}>{{ __('messages.activo') }} </option>
                                <option value="desactivo" {{ $tipo_entidade->status == 'desactivo' ? 'selected': '' }}>{{ __('messages.desactivo') }} </option>
                            </select>
                        </div>
