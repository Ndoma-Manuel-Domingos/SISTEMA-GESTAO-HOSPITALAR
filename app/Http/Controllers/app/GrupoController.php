...
class GrupoController extends Controller
{
    ...
    public function index()
    {
        ...
        $grupos = Grupo::with(["mesas.mesa"])->where('entidade_id', $entidade->entidade_id)->get();
        ...
        return view('dashboard.grupos.index', $head);
    }
    ...
    public function create()
    {
        ...
        $grupos = Grupo::where("entidade_id", $entidade->empresa->id)->get();
        ...
        return view('dashboard.grupos.create', $head);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function agrupar_mesas(Request $request)
    {
        $user = auth()->user();
        ...
        try {
            ...
            foreach ($request->mesa_id as $mesa) {

                $verificar = GrupoMesa::where("grupo_id", $request->grupo_id)
                    ->where("mesa_id", $mesa)
