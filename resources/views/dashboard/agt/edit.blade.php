                            ...
                            <div class="card-body row">
                                ...
                                <div class="col-12 col-md-12">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="codigo_postal" value="{{ $loja->codigo_postal }}" placeholder="Informe o Codigo Postal">
                                    </div>
                                    <p class="text-light-danger">
                                        @error('codigo_postal')
                                        {{ $message }}
                                ...
                                <div class="col-12 col-md-12">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="morada" value="{{ $loja->morada }}" placeholder="Informe a morada da Loja">
                                    </div>
                                    <p class="text-light-danger">
                                        @error('morada')
                                        {{ $message }}
                                ...
                                <div class="col-12 col-md-12">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="localidade" value="{{ $loja->localidade }}" placeholder="Informe a Localidade da Loja">
                                    </div>
                                    <p class="text-light-danger">
                                        @error('localidade')
                                        {{ $message }}
                                ...
                                <div class="col-12 col-md-12">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="telefone" value="{{ $loja->telefone }}" placeholder="Informe o Telefone">
                                    </div>
                                    <p class="text-light-danger">
                                        @error('telefone')
                                        {{ $message }}
                                ...
                                <div class="col-12 col-md-12">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="cae" value="{{ $loja->cae }}" placeholder="Informe o CAE">
                                    </div>
