                    ...
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <h5 class="info-box-number">
                                {{ number_format($facturasVencidas + $facturasVencidasCorrente, 2, ',', '.') }}
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <h5 class="info-box-number">{{ number_format($facturasVencidasCorrente, 2, ',', '.') }}
                                {{ $empresa_logada->empresa->moeda }}</h5>
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <h5 class="info-box-number">{{ number_format($facturasVencidas, 2, ',', '.') }}
                                {{ $empresa_logada->empresa->moeda }}</h5>
                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                <a href="{{ route('clientes-liquidar-factura', $cliente->id) }}" class="btn btn-light-primary"><i class="fas fa-file-invoice dollar-sign" title="Liquidar Fatura"></i> Liquidação de Facturas</a>
                            ...
                            <table class="table table-hover text-nowrap" id="carregar_tabela" style="width: 100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right text-light-danger">
                                            {{ number_format($movimento->valor_total, 2, ',', '.') }}
                                            {{ $empresa->empresa->moeda }}</td>
                                    </tr>
                                    @endforeach
