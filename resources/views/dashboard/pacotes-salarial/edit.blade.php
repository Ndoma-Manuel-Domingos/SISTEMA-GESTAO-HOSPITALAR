            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-default">
                        <form action="{{ route('pacotes-salarial.update', $pacote->id) }}" method="post" class="">
                            @csrf
                            @method('put')
                                        ...
                                        <div id="paconte-salarial" class="content" role="tabpanel" aria-labelledby="paconte-salarial-trigger">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <select type="text" class="form-control select2 @error('cargo_id') is-invalid @enderror" id="cargo_id" name="cargo_id">
                                                            ...
                                                            <option value="{{ $item->id ?? "" }}" {{ $pacote->cargo_id == $item->id ? 'selected' : '' }}>{{ $item->nome }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <select type="text" class="form-control select2 @error('categoria_id') is-invalid @enderror" id="categoria_id" name="categoria_id">
                                                            ...
                                                            <option value="{{ $item->id ?? "" }}" {{ $pacote->categoria_id == $item->id ? 'selected' : '' }}>{{ $item->nome }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="text" class="form-control @error('salario_base') is-invalid @enderror" name="salario_base" id="salario_base" value="{{ $pacote->salario_base ?? old('salario_base') }}" placeholder="Informe o valor base da remuneração">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <select type="text" class="form-control select2 @error('status') is-invalid @enderror" id="status" name="status">
                                                            <option value="activo" {{ $pacote->status == "activo" ? 'selected' : '' }}>{{ __('messages.activo') }} </option>
                                                            <option value="desactivo" {{ $pacote->status == "desactivo" ? 'selected' : '' }}>{{ __('messages.desactivo') }} </option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div id="paconte-subsidios" class="content" role="tabpanel" aria-labelledby="paconte-subsidios-trigger">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-12" id="dynamic-fields">
                                                    @foreach($pacote->subsidios_pacotes as $index => $subsidio)
                                                    <div class="field-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-md-4 col-lg-2">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    <input type="text" class="form-control @error('salario_subsidio') is-invalid @enderror" value="{{ $subsidio->salario }}" name="salario_subsidio[]" id="salario_subsidio_1" placeholder="Informe o Valor da remuneração">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-12 col-md-4 col-lg-2">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    <input type="text" class="form-control @error('limite_isencao') is-invalid @enderror" value="{{ $subsidio->limite_isencao }}" name="limite_isencao[]" id="limite_isencao_1" placeholder="Informe o Valor de Limite Isenção">
                                                                </div>
                                                            </div>
                                        ...
                                        <div id="paconte-descontos" class="content" role="tabpanel" aria-labelledby="paconte-descontos-trigger">
                                            <div class="row">
                                                <div class="col-12 col-md-12" id="dynamic-fields-descontos">
                                                    @foreach($pacote->desconto_pacotes as $index => $desconto)
                                                    <div class="field-group-desconto">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-md-4 col-lg-2">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    <input type="text" class="form-control @error('salario_desconto') is-invalid @enderror" value="{{ $desconto->salario }}" name="salario_desconto[]" id="salario_desconto_1" placeholder="Informe o Valor da remuneração">
                                                                </div>
                                                            </div>

                                                            <div class="col-12 col-md-4 col-lg-2">
                                                                <label for="tipo_valor_1" class="form-label">Tipo Valor</label>
                                                                <div class="input-group mb-3">
