...
<div class="content-wrapper">
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                    ...
                                                    <a class="dropdown-item" href="{{ route('gavetas.show', $item->id) }}"><i class="fas fa-eye text-light-primary"></i> {{ __('messages.mais_detalhes') }} </a>
                                                    @endif
    ...
    <form action="{{ route('gavetas.store') }}" method="post" class="">
        @csrf
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body row py-4">
                        ...
                        <div class="col-12 col-md-12">
                            ...
                            <div class="input-group mb-3">
                                <select name="camara_id" id="camara_id" class="form-control">
...
<script>
    ...
    $(document).on('click', '.edit-folder', function(e) {
        ...
        $.ajax({
            url: `{{ route('gavetas.edit', ':id') }}`.replace(':id', recordId)
            , method: 'GET'
            , data: {
            ...
            , success: function(response) {
                ...
                document.getElementById('camara_id').value = response.data.camara_id;
