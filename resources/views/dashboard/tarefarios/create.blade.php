        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-md-12">
                    <div class="card">
                        <form action="{{ route('tarefarios.store') }}" method="post" class="">
                            @csrf
                            <div class="card-body row">
                                <div class="col-12 col-md-6">
                                    <label for="nome" class="form-label"> {{ __('messages.designacao') }} </label>
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control  @error('nome') is-invalid @enderror" name="nome" id="nome" value="{{ old('nome') }}" placeholder="Informe uma Designação">
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control  @error('valor') is-invalid @enderror" name="valor" id="valor" value="{{ old('valor') }}" placeholder="Informe o valor">
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" id="valor_com_iva" name="valor_com_iva" value="{{ old('valor_com_iva') }}" placeholder="Preço Com IVA">
                                    </div>
                                    <p class="text-light-danger">
                                        @error('valor_com_iva')
                                        {{ $message }}
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <div class="input-group mb-3">
                                        <select type="text" class="form-control @error('modo_tarefario') is-invalid @enderror" id="modo_tarefario" name="modo_tarefario">
                                            ...
                                            <option value="Por Minutos">Por Minutos</option>
                                            <option value="Por Hora">Por Hora</option>
                                            <option value="Por Dia" selected>Por Dia</option>
                                            <option value="Por Semana">Por Semana</option>
                                            <option value="Por Quizena">Por Quizena</option>
                                            <option value="Por Mes">Por Mês</option>
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <div class="input-group mb-3">
                                        <select type="text" class="form-control @error('tipo_cobranca') is-invalid @enderror" id="tipo_cobranca" name="tipo_cobranca">
                                            ...
                                            <option value="Por Comodo" selected>Por Comodo</option>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        <select type="text" class="form-control select2 @error('quarto_id') is-invalid @enderror" multiple id="quarto_id" name="quarto_id[]">
                                            ...
                                            <option value="{{ $item->id ?? "" }}">{{ $item->nome }} - {{ $item->tipo->nome }} - {{ $item->andar->nome }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="card-footer">
                                @if (Auth::user()->can('criar todos') || Auth::user()->can('criar andar'))
