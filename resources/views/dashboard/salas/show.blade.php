                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        ...
                        <div class="card-footer clearfix d-flex">
                            <a href="{{ route('salas.edit', $sala->id) }}" class="btn btn-light-success mx-1">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="{{ route('salas.destroy', $sala->id ) }}" method="post">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-light-danger mx-1" onclick="return confirm('Tens Certeza que Desejas excluir esta Sala?')">
