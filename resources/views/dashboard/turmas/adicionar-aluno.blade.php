            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('clientes.show', $aluno->id ?? '') }}">{{ __('messages.voltar') }}</a>
                        </li>
                                ...
                                <div class="col-12 col-md-6 col-lg-4">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select type="text" class="form-control select2" name="matricula_id">
                                            ...
                                            <option value="{{ $item->id ?? "" }}">{{ $item->numero }} - Curso:
                                                {{ $item->curso->nome }} - Turno: {{ $item->turno->nome }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-6 col-lg-4">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select type="text" class="form-control select2" name="turma_id">
                                            ...
                                            <option value="{{ $item->id ?? "" }}">{{ $item->nome }} - Curso:
                                                {{ $item->curso->nome }} - Turno: {{ $item->turno->nome }}</option>
                                            @endforeach
                                        </select>
                                    </div>
