...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Unidades de Médidas</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                            ...
                            <table class="table table-hover text-nowrap" id="carregar_tabela" style="width: 100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->sigla }}</td>
                                        <td>{{ $item->tipo }}</td>
                                        <td>{{ number_format($item->fator_conversao, 2, ',', '.') }}</td>
    ...
    <form action="{{ route('unidades_medida.store') }}" method="post" class="">
        @csrf
        <div class="modal fade" id="modal-lg">
            <div class="modal-dialog modal-lg  modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Unidadas de Médidas</h4>
                    ...
                    <div class="modal-body row py-4">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control form-control-lg" name="sigla" id="sigla" value="{{ old('sigla') }}" placeholder="Sigla">
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <label for="tipo" class="form-label">Tipo</label>
                            <div class="input-group mb-3">
                                <select class="form-control form-control-lg" name="tipo" id="tipo" value="{{ old('tipo') }}">
                        ...
                        <div class="col-12 col-md-6">
                            <label for="fator_conversao" class="form-label">Factor conversão</label>
                            <div class="input-group mb-3">
                                <input type="text" class="form-control form-control-lg" name="fator_conversao" id="fator_conversao" value="{{ old('fator_conversao') }}" placeholder="Fator conversão">
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $(document).on('click', '.edit-folder', function(e) {
        ...
        $.ajax({
            url: `{{ route('unidades_medida.edit', ':id') }}`.replace(':id', recordId)
            , method: 'GET'
            , data: {
            ...
            , success: function(response) {
                ...
                document.getElementById('fator_conversao').value = response.data.fator_conversao;
    ...
    $(document).on('click', '.delete-record', function(e) {
        ...
        , }).then((result) => {
            if (result.isConfirmed) {
                // Envia a solicitação AJAX para excluir o registro
                $.ajax({
                    url: `{{ route('unidades_medida.destroy', ':id') }}`.replace(':id', recordId)
                    , method: 'DELETE'
                    , data: {
                        _token: '{{ csrf_token() }}', // Inclui o token CSRF
                    }
