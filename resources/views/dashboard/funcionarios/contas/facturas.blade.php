                                        ...
                                        <td class="text-right">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                    <a href="{{ route('facturas.show', [$item->id, 'tipo_documentos' => $item->factura]) }}" class="dropdown-item">Liquidar <i class="fas fa-file-invoice float-right
                                "></i> </a>
                                                    <a href="{{ route('anular-factura', $item->id) }}" class="dropdown-item">Anular <i class="fas fa-cancel float-right
                                "></i> </a>
                                                    <a href="{{ route('facturas.edit', $item->id) }}" class="dropdown-item">{{ __('messages.actualizar') }} <i class="fas fa-edit float-right
                                "></i> </a>
                                                    <a href="{{ route('facturas.edit', $item->id) }}" class="dropdown-item">{{ __('messages.imprimir') }} <i class="fas fa-print float-right
                                "></i> </a>
