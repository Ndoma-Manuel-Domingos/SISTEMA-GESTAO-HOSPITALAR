        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12 col-md-12">
                    <form action="{{ route('morgues.store') }}" method="post">
                        @csrf
                        <div class="card">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="col-12 col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <select type="text" class="form-control select2" width="100%" id="obito_id" name="obito_id">
                                            ...
                                            <option value="{{ $item->id ?? "" }}">{{ $item->documento_declaracao }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-3 mb-3">
                                    ...
                                    <input type="date" class="form-control" id="data_entrada_morgue" value="{{ old('data_entrada_morgue') ?? date("Y-m-d") }}" name="data_entrada_morgue">
                                </div>

                                <div class="col-12 col-md-3 mb-3">
                                    <label for="hora_entrada_morgue" class="form-label">Hora da Entrada a Morgue</label>
                                    <input type="time" class="form-control" id="hora_entrada_morgue" value="{{ old('hora_entrada_morgue') ?? date("H:i") }}" name="hora_entrada_morgue">
                                </div>

                                <div class="col-12 col-md-3 mb-3">
                                    <label for="data_liberacao" class="form-label">Data da Liberação</label>
                                    <input type="date" class="form-control" id="data_liberacao" value="{{ old('data_liberacao') ?? date("Y-m-d") }}" name="data_liberacao">
                                </div>

                                <div class="col-12 col-md-3 mb-3">
                                    <label for="hora_liberacao" class="form-label">Hora da Liberação</label>
                                    <input type="time" class="form-control" id="hora_liberacao" value="{{ old('hora_liberacao') ?? date("H:i") }}" name="hora_liberacao">
                                </div>
                                ...
                                <div class="col-12 col-md-6 mb-3">
                                    ...
                                    <textarea name="temperatura_armazenamento" class="form-control" id="temperatura_armazenamento" cols="30" rows="2"></textarea>
                                </div>

                                <div class="col-12 col-md-6 mb-3">
                                    <label for="observacoes_iniciais" class="form-label">{{ __('messages.observacao') }}</label>
                                    <textarea name="observacoes_iniciais" class="form-control" id="observacoes_iniciais" cols="30" rows="2"></textarea>
                                </div>
