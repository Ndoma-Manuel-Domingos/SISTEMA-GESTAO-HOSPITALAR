        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-md-12">
                    <form action="{{ route('contratos-postos.store') }}" method="post">
                        @csrf
                        <div class="card">
                            <div class="card-body row">
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <div class="input-group mb-3">
                                        <select type="text" class="form-control select2" id="contrato_id" name="contrato_id">
                                            <option value="">{{ __('messages.escolher') }}</option>
                                            @foreach ($contratos as $item)
                                            <option value="{{ $item->id ?? "" }}" {{ $item->id == ($contrato->id ?? "") ? "selected" : "" }}>{{ $item->codigo_contrato }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" id="nome" name="nome" placeholder="Designação">
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" id="representante_posto" name="representante_posto" placeholder="Representante do Posto">
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" value="+ 244" id="contacto_posto" name="contacto_posto" placeholder="Contacto principal do Posto">
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-12 row">
                                    <div class="col-12 col-md-3">
                                        ...
                                        <div class="input-group mb-3">
                                            <textarea name="endereco" id="endereco" class="form-control" placeholder="Data Final Contrato"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-3">
                                        ...
                                        <div class="input-group mb-3">
                                            <textarea name="instrucoes_especiais" id="instrucoes_especiais" class="form-control" placeholder="Instruções Especiais"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-3">
                                        ...
                                        <div class="input-group mb-3">
                                            <textarea name="horario_permitido" id="horario_permitido" class="form-control" placeholder="Horario Permitido"></textarea>
                                        </div>
                                    </div>
                                </div>
