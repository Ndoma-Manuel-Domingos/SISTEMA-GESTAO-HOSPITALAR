            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('departamentos.index') }}">{{ __('messages.voltar') }}</a></li>
                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        ...
                        <div class="card-footer clearfix d-flex">
                            <a href="{{ route('departamentos.edit', $departamento->id) }}" class="btn btn-light-success mx-1">
                                <i class="fas fa-edit"></i>
                            </a>

                            <button class="btn btn-light-danger mx-1 delete-record" data-id="{{ $departamento->id }}">
