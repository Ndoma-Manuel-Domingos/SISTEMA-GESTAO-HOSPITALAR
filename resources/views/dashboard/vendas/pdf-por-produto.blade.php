    ...
    <table>
        <thead>
            <tr>
                ...
                {{-- <th style="border: 1px solid #010101;padding: 2px;text-align: right;">Preco Custo</th> --}}
                ...
                {{-- <th style="border: 1px solid #010101;padding: 2px;text-align: right;"> {{ __('messages.quantidade') }} devolvida</th> --}}
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="padding: 3px;text-align: right;">{{ number_format($item->total_quantidade ?? 0, 0, ',', '.') }}</td>
                <td style="padding: 3px;text-align: right;">{{ number_format((($item->total_valor ?? 0) / ($item->total_quantidade ?? 0)), 4, ',', '.') }}</td>
                <td style="padding: 3px;text-align: left;">{{ number_format($item->produto->taxa ?? 0, 0, ',', '.') }} %</td>
                <td style="padding: 3px;text-align: right;">{{ number_format($item->total_lucro ?? 0, 2, ',', '.') }}</td>
                <td style="padding: 3px;text-align: right;">{{ number_format($item->total_valor ?? 0, 2, ',', '.') }}</td>
            </tr>
            @php
        ...
        <tfoot>
            <tr>
                <th style="border: 1px solid #010101;padding: 3px;text-align: right;" colspan="6">{{ __('messages.total') }}</th>
                 <th style="border: 1px solid #010101;padding: 3px;text-align: right;">{{ number_format($total_lucro ?? 0, 2, ',', '.') }}</th>
