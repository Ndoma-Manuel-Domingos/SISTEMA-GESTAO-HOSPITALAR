                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select type="text" class="form-control" name="status">
                                            <option value="1" {{ $tipoPagamento->status == true ? 'selected' : '' }}>{{ __('messages.activo') }} </option>
                                            <option value="0" {{ $tipoPagamento->status == false ? 'selected' : '' }}>{{ __('messages.desactivo') }} </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select name="troco" class="form-control" id="troco" aria-placeholder="Pode originar troco">
                                            ...
                                            <option value="1" {{ $tipoPagamento->status == true ? 'selected' : '' }}> {{ __('messages.sim') }} </option>
                                            <option value="0" {{ $tipoPagamento->status == false ? 'selected' : '' }}> {{ __('messages.nao') }} </option>
                                        </select>
                                    </div>
                                    <p class="text-light-danger">
                                        @error('troco')
