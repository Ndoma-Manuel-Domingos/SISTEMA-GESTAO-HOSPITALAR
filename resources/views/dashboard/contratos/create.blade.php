        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-md-12">
                    <form action="{{ route('contratos.store') }}" method="post" class="">
                        @csrf
                                    ...
                                    <div class="bs-stepper-content">
                                        <div id="paconte-contrato" class="content" role="tabpanel" aria-labelledby="paconte-contrato-trigger">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-2" style="width: 100%">
                                                    <label for="forma_pagamento_id" class="form-label">Formas de Pagamento</label>
                                                    <div class="input-group mb-3">
                                                        <select type="text" style="width: 100%" class="form-control select2 @error('forma_pagamento_id') is-invalid @enderror" name="forma_pagamento_id" id="forma_pagamento_id">
                                                ...
                                                <div class="col-12 col-md-2">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <select type="text" class="form-control select2 @error('dias_processamento') is-invalid @enderror" name="dias_processamento" id="dias_processamento">
                                                            <option value="">{{ __('messages.escolher') }} </option>
                                                            <option value="dias_uteis_variaveis">Dias Úteis Variáveis</option>
                                                            <option value="dias_fixo">Dias Fixos (30)</option>
                                                            <option value="dias_uteis_fixo" selected>Dias Úteis Fixos</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 col-md-2">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="number" class="form-control @error('subsidio_natal') is-invalid @enderror" name="subsidio_natal" id="subsidio_natal" value="{{ old('subsidio_natal') ?? 50 }}" placeholder="Informe o Valor em percentagem">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 col-md-2">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <select type="text" class="form-control @error('forma_pagamento_natal') is-invalid @enderror" id="forma_pagamento_natal" name="forma_pagamento_natal">
                                                            <option value="">{{ __('messages.escolher') }} </option>
                                                            <option value="completa" selected>Completa Mês Subsídio</option>
                                                            <option value="partes">Duodécimo</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 col-md-2">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="date" class="form-control @error('data_admissao') is-invalid @enderror" name="data_admissao" id="data_admissao" value="{{ old('data_admissao') ?? 0 }}" placeholder="Informe o contrato">
                                                    </div>
                                                </div>
