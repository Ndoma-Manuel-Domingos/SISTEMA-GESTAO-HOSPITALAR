...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Constituir Equipa Médica</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('equipas.index') }}">{{ __('messages.voltar') }}</a></li>
                        <li class="breadcrumb-item active">Equipa</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-md-12">
                    <form action="{{ route('equipas.store') }}" method="post" class="">
                        <div class="card">
                            @csrf
                            <div class="card-body row">
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" id="nome" name="nome" value="{{ old('nome') }}" placeholder="Informe a uma designação">
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" id="area_atuacao" name="area_atuacao" value="{{ old('area_atuacao') }}" placeholder="Informe  area atuação">
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5>Membros: <span id="valor_total" class="float-right"></span></h5>
                            </div>
                            <div class="card-body">
        ...
        if (profissional_id) {
            $.ajax({
                ...
                , success: function(res) {
                    ...
                    $("#valor_total").text(formatarNumero(res.total));
    ...
    $(document).on('click', '.delete-record', function(e) {
        ...
        , }).then((result) => {
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: `{{ route('adicionar-membros-equipas', ':id') }}`.replace(':id', recordId)
                    , method: 'DELETE'
                    , data: {
