...
class PeriodoRendimentoController extends Controller
{
    ...
    public function index()
    {
        ...
        if (!$user->can('listar todos') && !$user->can('listar periodo')) {
        ...
        $periodos = PeriodoRendimento::where("entidade_id", $entidade->empresa->id)->orderBy('created_at', 'desc')->get();
    ...
    public function store(Request $request)
    {
        ...
        if (!$user->can('criar todos') && !$user->can('criar periodo')) {
        ...
        try {
            ...
            $count = PeriodoRendimento::where('entidade_id', $entidade->empresa->id)->count();
    ...
    public function edit($id)
    {
        ...
        if (!$user->can('editar todos') && !$user->can('editar periodo')) {
    ...
    public function destroy($id)
    {
        ...
        if (!$user->can('eliminar todos') && !$user->can('eliminar periodo')) {
