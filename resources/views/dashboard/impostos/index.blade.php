...
<div class="content-wrapper">
    ...
    <form action="{{ route('impostos.store') }}" method="post" class="">
        @csrf
                    ...
                    <div class="modal-body row py-4">
                        <div class="col-12 col-md-6">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control form-control-lg" name="descricao" id="descricao" value="{{ old('descricao') }}" placeholder="Descrição">
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="input-group mb-3">
                                <input type="number" class="form-control form-control-lg" name="valor" id="valor" value="{{ old('valor') }}" placeholder="Valor">
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <div class="input-group mb-3">
                                <select type="text" class="form-control form-control-lg" id="codigo" name="codigo">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <div class="input-group mb-3">
                                <select type="text" class="form-control form-control-lg" id="text" name="text">
                                    <option value="Isenta">Isenta</option>
                                    <option value="Reduzida">Reduzida</option>
                                    <option value="Taxa Normal">Taxa Normal</option>
                                </select>
                            </div>
                        </div>

                        <div class="col-12 col-md-4">
                            <label for="tax_type" class="form-label">Tipo Texto</label>
                            <div class="input-group mb-3">
                                <select type="tax_type" class="form-control form-control-lg" id="tax_type" name="tax_type">
...
<script>
    ...
    $(document).on('click', '.edit-folder', function(e) {
        ...
        $.ajax({
            url: `{{ route('impostos.edit', ':id') }}`.replace(':id', recordId)
            , method: 'GET'
            , data: {
            ...
            , success: function(response) {
                ...
                document.getElementById('tax_type').value = response.data.tax_type;
    ...
    $(document).on('click', '.delete-record', function(e) {
        ...
        , }).then((result) => {
            if (result.isConfirmed) {
                // Envia a solicitação AJAX para excluir o registro
                $.ajax({
                    url: `{{ route('impostos.destroy', ':id') }}`.replace(':id', recordId)
                    , method: 'DELETE'
                    , data: {
                        _token: '{{ csrf_token() }}', // Inclui o token CSRF
                    }
