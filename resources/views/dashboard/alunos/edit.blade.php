                            ...
                            <div class="card-body row">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="codigo_postal" value="{{ $aluno->codigo_postal ?? old('codigo_postal') }}" placeholder="Informe codigo Postal">
                                    </div>
                                    <p class="text-light-danger">
                                        @error('codigo_postal')
                                        {{ $message }}
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="localidade" value="{{ $aluno->localidade ?? old('localidade') }}" placeholder="Informe  Localidade">
                                    </div>
                                    <p class="text-light-danger">
                                        @error('localidade')
                                        {{ $message }}
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="telefone" value="{{ $aluno->telefone ?? old('telefone') }}" placeholder="Informe Telefone">
                                    </div>
                                    <p class="text-light-danger">
                                        @error('telefone')
                                        {{ $message }}
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="telemovel" value="{{ $aluno->telemovel ?? old('telemovel') }}" placeholder="{{ __('messages.telemovel') }}">
                                    </div>
                                    <p class="text-light-danger">
                                        @error('telemovel')
                                        {{ $message }}
