    ...
    <div class="login-box">
        <div class="card card-outline card-dark">
            <div class="card-body py-5">
                <form action="{{ route('____status') }}" method="post" class="pt-3">
                    @csrf
                    <div class="col-12 mb-3">
                        <label for="documento" class="form-label">INFORMA O SEU NIF POR FAVOR: <span class="text-light-danger">*</span></label>
                        <div class="input-group">
                            <input type="text" class="form-control form-control-lg" id="documento" name="documento" value="{{ old('documento') }}" placeholder="Informe o nif da sua empresa">
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-12 mt-2">
                            <button type="submit" class="btn-lg btn-outline-dark btn-block">VALIDAR</button> <br>
                            <a href="{{ route('licenses.upload') }}" class="text-right h4 col-12 col-md-12">Activar Licença</a>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
            ...
            $('form').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    , success: function(response) {
                        ...
                        Swal.close();
                        showMessage('Sucesso!', 'Faça o Login para poder usar a sua conta!', 'success');
