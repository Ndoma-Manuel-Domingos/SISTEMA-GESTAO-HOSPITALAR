...
<body>
    ...
    <table>
        <thead>
            ...
            <tr>
                ...
                <th colspan="2" style="border: 1px solid #010101;text-align: left;padding: 3px"> {{ $cliente ? $cliente->nome : 'TODOS' }}</th>
                <th colspan="3" style="border: 1px solid #010101;text-align: left;padding: 3px">Quarto</th>
                <th colspan="3" style="border: 1px solid #010101;text-align: left;padding: 3px"> {{ $quarto ? $quarto->nome : 'TODAS' }}</th>
            </tr>
            <tr>
                <th colspan="3" style="border: 1px solid #010101;text-align: left;padding: 3px">Estado Pagamento</th>
                <th colspan="2" style="border: 1px solid #010101;text-align: left;padding: 3px"> {{ $requests['status_pagamento'] ?? 'TODOS' }}</th>
                <th colspan="3" style="border: 1px solid #010101;text-align: left;padding: 3px">Estado Reserva</th>
                <th colspan="3" style="border: 1px solid #010101;text-align: left;padding: 3px"> {{ $requests['status_reserva'] ?? 'TODAS' }}</th>
            </tr>
            <tr>
                <th colspan="3" style="border: 1px solid #010101;text-align: left;padding: 3px">Data de Entrada</th>
                <th colspan="2" style="border: 1px solid #010101;text-align: left;padding: 3px"> {{ $requests['data_inicio'] ?? 'TODAS' }}</th>
                <th colspan="3" style="border: 1px solid #010101;text-align: left;padding: 3px">Data de Saída</th>
                <th colspan="3" style="border: 1px solid #010101;text-align: left;padding: 3px"> {{ $requests['data_final'] ?? 'TODAS' }}</th>
            </tr>

            <tr>
                <th colspan="3" style="border: 1px solid #010101;text-align: left;padding: 3px">Hora Entrada</th>
                <th colspan="2" style="border: 1px solid #010101;text-align: left;padding: 3px"> {{ $requests['hora_entrada'] ?? 'TODAS' }}</th>
                <th colspan="3" style="border: 1px solid #010101;text-align: left;padding: 3px">Hora Saída</th>
                <th colspan="3" style="border: 1px solid #010101;text-align: left;padding: 3px"> {{ $requests['hora_saida'] ?? 'TODAS' }}</th>
            </tr>
        </thead>
    </table>
    ...
    <table>
        ...
        <tbody>
            ...
            @endforeach
            <tr>
                <th colspan="11" style="border: 1px solid #010101;padding: 2px;text-transform: uppercase;text-align: left"> TOTAL REGISTRO: {{ count($reservas) }}</th>
            </tr>
        </tbody>
    </table>
