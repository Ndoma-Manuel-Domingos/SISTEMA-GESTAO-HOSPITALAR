...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">{{ __('messages.desconto') }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                @if (Auth::user()->can('criar todos') || Auth::user()->can('criar desconto'))
                            ...
                            <table class="table table-hover text-nowrap" id="carregar_tabela" style="width: 100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->nome ?? "" }}</td>
                                        <td>{{ $item->status }}</td>
                                        <td>{{ $item->tipo_valor == "P" ? "Percentual" : "Ordinário ou Extenso" }}</td>
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                    @if (Auth::user()->can('editar todos') || Auth::user()->can('editar desconto'))
                                                    ...
                                                    @if (Auth::user()->can('eliminar todos') || Auth::user()->can('eliminar desconto'))
    ...
    <form action="{{ route('descontos.store') }}" method="post" class="">
        @csrf
            ...
            <div class="modal-dialog modal-xl  modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body row py-4">
                        ...
                        <div class="col-12 col-md-6">
                            <label for="desconto" class="form-label">Valor (%)</label>
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" name="desconto" id="desconto" value="0" placeholder="Informe a valor em percentagem">
                            </div>
                        </div>

                        <div class="col-12 col-md-6">
                            <label for="tipo_valor" class="form-label">Tipo Valor</label>
                            <div class="input-group mb-3">
...
<script>
    ...
    $(document).on('click', '.edit-folder', function(e) {
        ...
        $.ajax({
            url: `{{ route('descontos.edit', ':id') }}`.replace(':id', recordId)
            , method: 'GET'
            , data: {
            ...
            , success: function(response) {
                ...
                document.getElementById('tipo_valor').value = response.data.tipo_valor;
