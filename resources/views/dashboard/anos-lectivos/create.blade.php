                            ...
                            <div class="card-body row">
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="nome" class="form-control" name="nome" value="{{ old('nome') }}" placeholder="Informe a turno">
                                    </div>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="sigla" value="{{ old('sigla') }}" placeholder="Informe a Sigla">
                                    </div>
                                    <p class="text-light-danger">
                                        @error('sigla')
                                        {{ $message }}
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="date" class="form-control" name="data_inicio" value="{{ old('data_inicio') }}" placeholder="Informe a data inicio">
                                    </div>
                                    <p class="text-light-danger">
                                        @error('data_inicio')
                                        {{ $message }}
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="date" class="form-control" name="data_final" value="{{ old('data_final') }}" placeholder="Informe a data final">
                                    </div>
                                    <p class="text-light-danger">
                                        @error('data_final')
                                        {{ $message }}
