...
<body>
    ...
    <table>
        <thead>
            <tr>
                <th colspan="10" style="text-transform: uppercase"> {{ $titulo }} - SALDOS EM CAIXAS</th>
            </tr>
        </thead>
    </table>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="border: 1px solid #010101;padding: 2px;text-align: right">Credito</th>
                <th style="border: 1px solid #010101;padding: 2px;text-align: right">Debito</th>
                <th style="border: 1px solid #010101;padding: 2px;text-align: right">Saldo</th>
            </tr>
        ...
        <tbody>
            ...
            @foreach ($saldos_caixas as $item)
                ...
                <tr>
                    ...
                    <td style="padding: 3px;text-align: right">- {{ number_format($item->despesa, 2, ',', '.') }}</td>
                    <td style="padding: 3px;text-align: right">+ {{ number_format($item->receita, 2, ',', '.') }}</td>
                    <td style="padding: 3px;text-align: right">
                        {{ number_format($item->receita - $item->despesa, 2, ',', '.') }}</td>
                </tr>
            @endforeach
        <tfoot>
            <tr>
                ...
                <th style="border: 1px solid #010101;padding: 2px;text-align: right;">-
                    {{ number_format($cred, 2, ',', '.') }}</th>
                <th style="border: 1px solid #010101;padding: 2px;text-align: right;">+
                    {{ number_format($debi, 2, ',', '.') }}</th>
                <th style="border: 1px solid #010101;padding: 2px;text-align: right;">
                    {{ number_format($debi - $cred, 2, ',', '.') }}</th>
            </tr>
        </tfoot>
        </tbody>
    </table>
