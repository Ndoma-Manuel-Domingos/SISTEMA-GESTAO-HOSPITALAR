        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-md-12">
                    <form action="{{ route('formadores-videos.videos') }}" method="GET">
                        @csrf
                        <div class="card">
                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('formadores-videos.create-video') }}" class="btn-light-primary btn"> <i class="fas fa-plus"></i> {{ __('messages.novo') }}</a>
                        </div>
