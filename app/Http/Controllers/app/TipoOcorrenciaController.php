...
class TipoOcorrenciaController extends Controller
{
    ...
    public function index()
    {
        ...
        $tipos = TipoOcorrencia::where('entidade_id', $entidade->entidade_id)->get();
        ...
        return view('dashboard.tipos-ocorrencias.index', $head);
    }
    ...
    public function edit($id)
    {
        ...
        $posto = TipoOcorrencia::findOrFail($id);
