    ...
    <table class="table" style="margin: 20px 0">
        <thead>
            <tr>
                ...
                <th style="border: 1px solid #010101;padding: 2px;">Referente</th>
                ...
                <th style="border: 1px solid #010101;padding: 2px;text-align: right">Dívida</th>
            </tr>
        </thead>
        <tbody>
            @if ($facturas)
                @foreach ($facturas as $item)
                    <tr>
                        ...
                        <td style="padding: 3px;text-align: left">{{ $item->facturas->factura_next }}</td>
