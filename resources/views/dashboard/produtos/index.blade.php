        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <h1 class="m-0"> {{ $_GET['tipo'] == "P" ? __('messages.produtos') : __('messages.servico') }}</h1>
                    @else
                    <h1 class="m-0">{{ __('messages.produtos') }} & {{ __('messages.servico') }}</h1>
                    @endif
                </div><!-- /.col -->
                <div class="col-sm-6">
                                ...
                                <div class="col-12 col-md-3">
                                    <div class="input-group mb-3">
                                        <select type="text" class="form-control" name="tipo">
                                            ...
                                            <option value="P" {{ $requests['tipo'] == "P" ? 'selected' : '' }}>{{ __('messages.produtos') }}</option>
                                            <option value="S" {{ $requests['tipo'] == "S" ? 'selected' : '' }}>{{ __('messages.servico') }}</option>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('pdf-produto-excel', ['categoria_id' => $requests['categoria_id'] ?? "",'tipo' => $requests['tipo'] ?? "", 'marca_id' => $requests['marca_id'] ?? ""]) }}" target="_blank" class="btn btn-light-success float-right"><i class="fas fa-file-excel"></i> {{ __('messages.exportar_excel') }}</a>
                                <a href="{{ route('pdf-produto', ['categoria_id' => $requests['categoria_id'] ?? "",'tipo' => $requests['tipo'] ?? "", 'marca_id' => $requests['marca_id'] ?? ""]) }}" target="_blank" class="btn btn-light-primary float-right"><i class="fas fa-file-pdf"></i> {{ __('messages.exportar_pdf') }}</a>
                            </div>
                        </div>
