                            ...
                            <div class="card-body row">
                                <div class="col-12 col-md-3">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('nome') is-invalid @enderror" name="nome" value="{{ $periodo->nome }}" placeholder="Informe a Exercício">
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="date" class="form-control @error('inicio') is-invalid @enderror" name="inicio" id="inicio" value="{{ $periodo->inicio ?? old('inicio') }}" placeholder="Informe a data ínicio">
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="date" class="form-control @error('final') is-invalid @enderror" name="final" id="final" value="{{ $periodo->final ?? old('final') }}" placeholder="Informe a data final">
                                    </div>
                                </div>
