    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-dark">
            <div class="card-body py-5">
                <form action="{{ route('definir_senha_check') }}" method="post" class="pt-3">
                    @csrf
                    <div class="col-12 col-md-12 mb-3">
                        <label for="email" class="label-form"> {{ __('messages.email') }}:</label>
                    ...
                    <div class="row">
                        <div class="col-12 mt-2">
                            <button type="submit" class="btn-lg btn-outline-dark btn-block">Redefinir Senha</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
                ...
                <p class="mb-0 mt-3 text-center">
                    <a href="{{ route('login') }}" class="text-right h4">Acessar sua conta!</a>
                </p>
