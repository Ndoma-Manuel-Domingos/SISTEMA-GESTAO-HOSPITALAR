...
class TipoReservaController extends Controller
{
    ...
    public function index()
    {
        ...
        $dados = TipoReserva::where('entidade_id', '=', $entidade->empresa->id)->orderBy('created_at', 'desc')->get();
        ...
        return view('dashboard.tipos-reservas.index', $head);
    }
    ...
    public function store(Request $request)
    {
        ...
        if (!$user->can('criar todos') && !$user->can('criar reserva')) {
            return redirect()->back()->with('error-permissao', "Você não possui permissão para esta operação, por favor, contacte o administrador!");
        }
    ...
    public function edit($id)
    {
        ...
        $reserva = TipoReserva::findOrFail($id);
