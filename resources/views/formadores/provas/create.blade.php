                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-3">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="date" class="form-control @error('data_final_prova') is-invalid @enderror" id="data_final_prova" name="data_final_prova" value="{{ old('data_final_prova') }}" placeholder="Informe">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-3">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control @error('horas_prova') is-invalid @enderror" id="horas_prova" name="horas_prova" value="{{ old('horas_prova') }}" placeholder="Informe">
                                        </div>
                                    </div>
