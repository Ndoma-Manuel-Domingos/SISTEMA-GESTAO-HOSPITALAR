...
<div class="login-box">
    <div class="card card-outline card-info">
        <div class="card-header text-center">
            <a href="{{ route('congelamento-pin') }}" class="h1">{{ env('APP_NAME') }}</a>
        </div>
        <div class="card-body pb-5">
            <p class="login-box-msg text-uppercase">Por favor informe o Pin de Segurança para abrir aplicação.</p>
            <form action="{{ route('congelamento-pin-post') }}" method="post">
                @csrf
                <div class="my-3">
