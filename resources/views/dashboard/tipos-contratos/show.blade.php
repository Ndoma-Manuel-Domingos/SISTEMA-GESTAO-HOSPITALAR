            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('tipos-contratos.index') }}">{{ __('messages.voltar') }}</a></li>
                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        ...
                        <div class="card-footer clearfix d-flex">
                            <a href="{{ route('tipos-contratos.edit', $tipo_contrato->id) }}" class="btn btn-light-success mx-1">
                                <i class="fas fa-edit"></i>
                            </a>
                            <button class="btn btn-light-danger mx-1 delete-record" data-id="{{ $tipo_contrato->id }}">
    ...
    $(document).on('click', '.delete-record', function(e) {
        ...
        , }).then((result) => {
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: `{{ route('tipos-contratos.destroy', ':id') }}`.replace(':id', recordId)
                    , method: 'DELETE'
                    , data: {
